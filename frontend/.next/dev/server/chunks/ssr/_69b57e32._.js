...
"[project]/app/app/taxes/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewTaxPage() {
    ...
    const loadVehicles = async ()=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$vehicles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vehiclesApi"].getAll();
            setVehicles(data);
        } catch (error) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$taxes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["taxesApi"].create(data);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Tax record created successfully");
            router.push("/app/taxes");
        } catch (error) {
            console.error("Failed to create tax record:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to create tax record");
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=_69b57e32._.js.map