...
function NewVehiclePage() {
    ...
    const handleSubmit = async (data)=>{
        setIsLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$vehicles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vehiclesApi"].create(data);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to create vehicle");
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=_b1ee06d2._.js.map