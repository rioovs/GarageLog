  ...
  return (
    <Card className="border-border relative">
      ...
      <div className="p-8 space-y-8">
        ...
        {/* OAuth Buttons */}
        <Button variant="outline" className="w-full bg-transparent" type="button" disabled={isLoading} onClick={handleGoogleLogin}>
        ...
        <div className="text-center text-sm">
          ...
          <Link href="/register" className="font-medium text-foreground hover:text-muted-foreground transition-colors">
            {t('auth.signUp')}
          </Link>
        </div>
      </div>
